...
func TestProjectionRoundTrip(t *testing.T) {
	...
	tests := []struct {
		...
		{"South Cap (S) - Center", 0.0, -75.0},
		{"South Cap (S) - Quadrant c0", -135.0, -75.0},
		{"South Cap (S) - Quadrant c1", -45.0, -75.0},
		{"South Cap (S) - Quadrant c2", 45.0, -75.0},
		{"South Cap (S) - Quadrant c3 (Pilbara polar)", 135.0, -75.0},
		{"South Cap (S) - Anti-meridian", -179.99, -70.0},
